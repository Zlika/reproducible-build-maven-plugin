...
File artifact1 = new File(basedir, "target1/nested-jar-1.0-SNAPSHOT.jar");
...
// Check that both artifacts produced by the two builds are the nested
byte[] content1 = Files.readAllBytes(artifact1.toPath());
byte[] content2 = Files.readAllBytes(new File(basedir, "target2/nested-jar-1.0-SNAPSHOT.jar").toPath());
