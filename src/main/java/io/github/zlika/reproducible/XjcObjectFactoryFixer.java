...
/**
 * Fixes ObjectFactory java files generated by xjc.
 * xjc (before version 2.2.11) generates ObjectFactory.java files where the methods
 * are put with a non-predictable order (cf.https://java.net/jira/browse/JAXB-598).
