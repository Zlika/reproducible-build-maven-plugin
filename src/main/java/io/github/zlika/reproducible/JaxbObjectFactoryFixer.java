...
final class JaxbObjectFactoryFixer implements Stripper
{
    ...
    public void strip(File in, File out) throws IOException
    {
        ...
        methods.stream().sorted().forEach(builder::append);
    ...
    {
        return (content.contains("JavaTM Architecture for XML Binding") && content.contains("(JAXB)")
                || content.contains("generated by the Eclipse Implementation of JAXB"))
